...
import { search, type SearchOptions, type SearchResults } from "../search/index";
...
): ComputedRef<SearchResults> {
  return computed(() => search(policyIndex, query.value, options.value));
}
